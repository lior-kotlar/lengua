...
| 1 | [phase-1-backend-core.md](phase-1-backend-core.md) | FastAPI + Postgres core loop, LLM seam, OpenAPI | L | 0 | 34 | **in progress** — 1.1 done (lengua_core ported to a pure core: scheduler/proficiency/cards/config; SQLite relocated to legacy_streamlit/store; legacy app still runnable). 1.2–1.7 not started. |
