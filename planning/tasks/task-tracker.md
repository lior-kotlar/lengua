...
**Track-1 code items** (`/next-task` — the §1.1 limiter bound is the only required one) run any
time. Then, in order: **M4 prod cutover** (owner — go-live §F) → **P7 mobile** (Capacitor, signed
