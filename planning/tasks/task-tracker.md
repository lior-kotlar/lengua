...
|------:|------|-------|:------:|------------|:-----:|--------|
| 0 | [phase-0-foundations.md](phase-0-foundations.md) | Monorepo, tooling, CI quality gate, accounts | S–M | — | 45 | in progress (0.1.x, 0.2.x, 0.3.x, 0.4.x, **0.5.1–0.5.9 CI gate**, 0.6.1, **0.6.2**, 0.7.1–0.7.6, 0.7.11, 0.8.x done; remaining: 0.5.10 gate-on-`main` confirmation + owner items 0.6.3/0.6.4/0.7.7–0.7.10) |
