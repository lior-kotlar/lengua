    ...
    <div className="flex items-center gap-2">
      <Popover>
        <PopoverTrigger
          ...
          className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-primary/15 text-[12px] font-semibold text-primary transition duration-150 ease-apple active:scale-[0.92] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
        >
